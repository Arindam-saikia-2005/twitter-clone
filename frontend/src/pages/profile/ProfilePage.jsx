...
import { POSTS } from "../../utlis/db/dumm.js";
...
import {formatMemberSinceDate} from "../../utlis/date/date.js"
	...
	const { mutate : updateProfile, isPending : isUpdatingProfile} = useMutation({
		mutationFn:async() => {
           try {
			const res = await fetch("/api/user/update",{
				...
				body:JSON.stringify({
					coverImg, profilePic:profileImg
				})
			})
			const responseData = await res.json()
		...
		onSuccess:(updatedUser) => {
			...
			queryClient.setQueryData(["authUser"], (prev) => ({
				...prev,
				profileImg: updatedUser.profileImg, // Update the profileImg immediately
							...
							<div className='relative group/cover'>
								...
								<div className='avatar absolute -bottom-16 left-4'>
									<div className='w-32 rounded-full relative group/avatar'>
										<img src={profileImg || user?.profilePic || authUser?.profilePic || "/avatar-placeholder.png"} alt="" />
